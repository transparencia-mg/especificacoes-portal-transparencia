...
|Fonte de Recurso |Identifica a origem e a destinação dos recursos legalmente vinculados a órgão, fundo ou despesa.
|Fonte de Recurso - 2023 | Identifica a origem e a destinação dos recursos legalmente vinculados a órgão, fundo ou despesa conforme determina a Portaria nº 710/2021 da Secretaria de Tesouro Nacional
|Indicador de Procedência e Uso (IPU)|Identifica a origem e a utilização dos recursos.    
| Empenho  |Número de identificação do documento de empenho no SIAFI-MG   
|Número do Processo de Compra       |Número identificador no processo de compra no SIAD-MG
