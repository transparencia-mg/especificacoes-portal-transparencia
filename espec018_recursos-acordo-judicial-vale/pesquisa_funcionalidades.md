# PESQUISA PARA A VIABILIDADES DAS SUGESTÕES DOS USUÁRIOS
...
#### 9. LINK PARA O PORTAL DE DADOS ABERTOS
...
- [ ] CONCLUÍDO
    ...
    - SOLUÇÃO:
        - Inserir o Glossário de Termos para que o usuário consulta o significado sem a necessidade de sair da página da consulta. Ao clicar sobre o termo sublinhado, será exibido um menu lateral com a explicação do termo pesquisado e a opção de clicar para saber mais informações.
...
#### 7. MELHORAR A VISUALIZAÇÃO DE NOTÍCIAS
...
###### Sugestão:
1. [Campo Grande](https://transparencia.campogrande.ms.gov.br/)
