...
4) Acesso à área administrativa pela DTA
  - Essa funcionalidade permitirá que a equipe DTA realize alterações e acrescente informações a serem exibidas no painel de destaque da página inicial.
...
- A área administrativa do Portal deverá permitir que a equipe da DTA altere o texto explicativo das pesquisa básica, bem como os termos que ficarão em destaque
